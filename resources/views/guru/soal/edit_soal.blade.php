<section id="content" style="overflow: visible;">
    ...
    <div class="container">
     ...
     <div class="jumbotron jumbotron-fluid mt-3">
      <div class="container">
       ...
       <form method="POST" action="{{ url('guru/soal/konten_soal/'.$kontensoal->soal_id.'/'.$kontensoal->id.'') }}" id="soal">
         @csrf
         @method('PATCH')
    ...
    <a href="{{ url('guru/soal/konten_soal/'.$kontensoal->soal_id.'') }}" class="btn btn-danger float-right mr-2">Kembali</a>
